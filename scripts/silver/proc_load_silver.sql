...
==============================================================================================================
Script Purpose: 
		This stored procedure performs the ETL (Etract, Transform, Load) process to 
...
BEGIN
	...
	BEGIN TRY
		...
		FROM (
			SELECT *,
			ROW_NUMBER() OVER(PARTITION BY cst_id ORDER BY cst_create_date DESC) AS Flag_Last -- To get unique primary ID's with latest creation date
